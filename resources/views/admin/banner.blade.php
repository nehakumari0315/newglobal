    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="banner.html">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-12">
                        <div class="card mb-3">
                            <div class="header-area">
                                ...
                                <a href="add-banner.html" class="btn  bg-gradient-primary"> Add banner</a>
                            </div>
                        </div>
                      <div class="card mb-4">
                        <div class="card-body px-0 pt-0 pb-2">
                          <div class="table-responsive p-0">
                            <table class="table align-items-center justify-content-center mb-0">
                              <thead>
                                <tr>
                                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Banner-1</th>
                                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Banner-2</th>
                                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Banner-2</th>
                              ...
                              <tbody>
                                <tr>
                                  <td>
                                    <div class="banner">
                                        <img src="{{url('assets/img/team-3.jpg')}}" class="img-fluid" alt="user">
                                    </div>
                                  </td>
                                  <td>
                                    <div class="banner">
                                        <img src="{{url('assets/img/team-1.jpg')}}" class="img-fluid" alt="user">
                                    </div>
                                  </td>
                                  <td>
                                    <div class="banner">
                                        <img src="{{url('assets/img/team-2.jpg')}}" class="img-fluid" alt="user">
                                    </div>
                                  </td>
                                  <td class="d-flex align-items-center">
                                    <a class="btn btn-sm bg-gradient-success mb-0 me-2" href="edit-banner.html">
