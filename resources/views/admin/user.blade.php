                    ...
                    <div class="col-12">
                        <div class="card mb-3">
                            <div class="header-area">
                                ...
                                <a href="add-users.html" class="btn  bg-gradient-primary"> Add Users</a>
                            </div>
                        </div>
                      <div class="card mb-4">
                            ...
                            <table class="table align-items-center justify-content-center mb-0">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    <h6 class="mb-0 text-sm">John Deo</h6>
                                  </td>
                                  <td>
                                    <h6 class="mb-0 text-sm">john123@gmail.com</h6>
                                  </td>
                                  <td>
                                    <h6 class="mb-0 text-sm">+1 999 999 9999</h6>
                                  </td>
                                  <td class="d-flex align-items-center">
                                    <a class="btn btn-sm bg-gradient-success mb-0 me-2" href="edit-user.html">
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <div class="user-img">
                                          <img src="assets/img/marie.jpg" class="img-fluid" alt="user">
                                      </div>
                                    </td>
                                    <td>
                                      <h6 class="mb-0 text-sm">John Deo</h6>
