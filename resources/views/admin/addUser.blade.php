                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-8">
                      ...
                      <div class="card mb-4">
                        ...
                        <label>Email</label>
                        <div class="mb-3">
                          <input type="email" class="form-control" placeholder="Email address" aria-label="Email" aria-describedby="Email-addon">
                        </div>
                        <label>Phone Number</label>
                        <div class="mb-3">
                          <input type="Number" class="form-control" placeholder="Phone number" aria-label="Number" aria-describedby="number-addon">
                        </div>
                        <div class="">
