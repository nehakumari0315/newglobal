            ...
            <div class="container-fluid py-1 px-3">
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav ms-md-auto  justify-content-end">
                        ...
                        <li
                            class="nav-item d-xl-none ps-3 d-flex align-items-center shadow border-radius-md bg-white text-body icon-lg">
                    ...
                    <div class="col-12">
                        <div class="card mb-3">
                            <div class="header-area">
                                ...
                                <a href="add-category.html" class="btn  bg-gradient-primary"> Add category</a>
                            </div>
                        </div>
                        <div class="card mb-4">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center">
                                                    <a class="btn btn-sm bg-gradient-success mb-0 me-2" href="edit-category.html">
                                                    ...
                                                    <div class="form-check form-switch ps-0">
                                                        ...
                                                        <label
                                                            class="form-check-label text-body ms-3 text-truncate w-80 mb-0"></label>
                                                    </div>
                                                </td>
